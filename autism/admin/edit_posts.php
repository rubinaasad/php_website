...
<?php
	...
	exit();
	 ...
	 move_uploaded_file($image_tmp,"../images/$post_image1");
		...
		$update_query = "update post set post_title='$post_title1',post_date='$post_date1',post_author='$post_author1',post_image='$post_image1',post_keywords='$post_keywords1',post_content='$post_content1' where post_id='$update_id'";
